...
import (
	...
	"github.com/ahmetcoskunkizilkaya/vibecheck/backend/internal/database"
	...
	"github.com/ahmetcoskunkizilkaya/vibecheck/backend/internal/routes"
...
func main() {
	...
	// Routes
	routes.Setup(app, cfg, database.DB, authHandler, healthHandler, webhookHandler, moderationHandler, vibeHandler)
