  ...
  return (
    <SafeAreaView className="flex-1 bg-gray-950" edges={['top']}>
      <View className="flex-1 px-6 pt-8">
        ...
        {isGuest && (
          <Pressable
            className="mb-6 rounded-2xl bg-indigo-500/10 border border-indigo-500/30 p-5"
        ...
        {isAuthenticated && (
          <>
            ...
            <View className="rounded-xl bg-red-950/50 border border-red-900/50">
        ...
        {/* Guest Sign Out */}
        {isGuest && (
          <Pressable className="mt-4 items-center py-3" onPress={logout}>
            <Text className="text-base font-medium text-gray-400">Exit Guest Mode</Text>
          </Pressable>
        )}
      </View>
